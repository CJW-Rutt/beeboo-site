...
This is a website application created for the collaborative project between the *Design 2* and the  *Dynamic Content Design* courses took as part of the *Digital Design and Development Program* at the *British Columbia Institute of Technology (BCIT)*. Three students are activelly working on this code on a weekly basis until May.
